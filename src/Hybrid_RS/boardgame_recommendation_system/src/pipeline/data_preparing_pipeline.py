...
class DataPreparingTrainingPipeline:
    ...
    def main(self):
        ...
        ratings_cfb_data = data_preparing.file_ratings(ratings_df, bg_cfb_data)

        data_preparing.save_dataset_preparing(ratings_cfb_data, file_name = "weight_ratings_hb_preparing")
