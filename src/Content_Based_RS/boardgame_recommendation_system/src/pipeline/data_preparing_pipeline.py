...
class DataPreparingTrainingPipeline:
    ...
    def main(self):
        ...
        ratings_cfb_data = data_preparing.file_ratings(ratings_df, bg_df)

        data_preparing.save_dataset_preparing(ratings_cfb_data, file_name ="knowledge_data_cb_preparing")
        
        print(ratings_cfb_data.head())
